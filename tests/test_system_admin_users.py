...
def test_verify_users_page_fields(environment_to_run, ontrack_username, ontrack_password, ontrack_login_page,
                                  system_admin_users_page, tab_to_navigate, headers_text):
    """
    ...
    system_admin_users_page.verify_and_click_on_users_tab(side_navigation_item=tab_to_navigate)
...
def test_users_list_filters(
    environment_to_run, system_admin_users_page, available_filter_options, expected_statuses,
    ...
    system_admin_users_page.verify_filters_field_and_filter_options(available_filter_options=available_filter_options)
    # 4. Apply all available filters and verify filtered data
    system_admin_users_page.apply_filters_and_verify_filtered_data(available_filter_options, expected_statuses)
...
def test_batch_action(environment_to_run, system_admin_users_page,
    ontrack_login_page, ontrack_password, ontrack_username, tab_to_navigate):
    """
...
def test_invite_system_admin_and_sender(environment_to_run, system_admin_users_page, first_name, last_name, email, user_type_select,
    ontrack_login_page, ontrack_password, ontrack_username, tab_to_navigate):
    """
    ...
    system_admin_users_page.verify_and_invite_system_admin_and_sender_functionality(first_name, last_name, email, user_types=user_type_select)
...
def test_invite_deployment_admin(environment_to_run, system_admin_users_page, first_name, last_name, email, user_type_select,
    ontrack_login_page, ontrack_password, ontrack_username, tab_to_navigate, deployment_name):
    """
       Regression test for invite users functionality
    """
    # 1. Navigate to ontrack log, in page and verify all element of login page
    ...
    system_admin_users_page.verify_and_click_on_users_tab(side_navigation_item=tab_to_navigate)
    # 3. Verify invite user functionality
    system_admin_users_page.invite_deployment_admin(first_name, last_name, email, user_type=user_type_select, deployment_name = deployment_name)
...
def test_invite_vendor(environment_to_run, system_admin_users_page, first_name, last_name, email, user_type_select,
    ontrack_login_page, ontrack_password, ontrack_username, tab_to_navigate, vendor_to_select):
    """
       Regression test for invite users functionality
    """
    # 1. Navigate to ontrack log, in page and verify all element of login page
    ...
    system_admin_users_page.verify_and_click_on_users_tab(side_navigation_item=tab_to_navigate)
    # 3. Verify invite user functionality
    system_admin_users_page.invite_vendor(first_name, last_name, email, user_type_select=user_type_select, vendor=vendor_to_select)
...
@qase.title("system admin should be able to active and suspend single user from actions")
# @qase.id(2)
@qase.fields(
    ("severity", "major"),
    ("priority", "high"),
...
def test_active_and_suspend_single_user(environment_to_run, system_admin_users_page,
    ontrack_login_page, ontrack_password, ontrack_username, tab_to_navigate):
    """
        Regression test for users lists Batch action
    """
...
def test_delete_user_from_list(environment_to_run, system_admin_users_page,
    ontrack_login_page, ontrack_password, ontrack_username, tab_to_navigate):
    """
        Regression test for users lists Batch action
    """
