...
class SystemAdminDeploymentsParams:
    ...
    Test_5 = {
        "tab_to_navigate": "Deployments",
        "headers_text": ['Profile Image', 'ID', 'First Name', 'Last Name', 'Email', 'Phone Number', 'Status', 'Actions']
    }
    Test_6 = {
        "tab_to_navigate": "Deployments",
    ...
    Test_7 = {
        ...
        "headers_text": ['Thumbnail', 'ID', 'Item ID', 'Deployment ID', 'Deployment Name', 'Send Time', 'Date Created', 'Status']
    }
    Test_8 = {
        "tab_to_navigate": "Deployments",
