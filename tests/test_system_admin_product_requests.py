...
def test_verify_system_admin_product_request_page_elements(
    ...
    ontrack_password,
    ontrack_login_page,
    system_admin_product_requests_page,
    tab_to_navigate,
):
    ...
    system_admin_product_requests_page.verify_and_click_on_product_request_tab(
        side_navigation_item=tab_to_navigate
    )
    # 3. Verify product request page elements availability
    system_admin_product_requests_page.verify_product_request_page_elements()
...
def test_verify_system_admin_product_request_page_add_item(
    ...
    system_admin_product_requests_page.verify_approve_and_add_item_functionality()
...
def test_verify_system_admin_product_request_page_add_item(
    ...
    # 3. Verify approve and add item functionality
    system_admin_product_requests_page.apply_filter_on_product_request_and_verify_filtered_data(
