...
def test_batch_action_on_deployments_list(
    ...
    system_admin_deployments_page.apply_batch_actions_to_deployments_list(
...
def test_delete_single_deployment_from_deployment_list(
    ...
    # 3. Verify Batch action functionality
    system_admin_deployments_page.delete_deployments_from_actions(
        success_message=success_message
    )
...
def test_deployment_summary_users_tab_fields(
    ...
    system_admin_deployments_page.verify_deployment_summary_users_tab_fields(
        headers_text=headers_text
    )
...
def test_deployment_summary_sends_tab_fields(
    ...
    # 3. Verify sends tab
    system_admin_deployments_page.verify_deployment_summary_sends_tab_fields(
        headers_text=headers_text, tab_to_navigate=deployment_summary_tab_navigation
    )
...
def test_deployment_summary_account_balance_tab_fields(
    ...
    system_admin_deployments_page.verify_deployment_summary_account_balance_tab_fields(
        account_balance_title=account_balance_title,
